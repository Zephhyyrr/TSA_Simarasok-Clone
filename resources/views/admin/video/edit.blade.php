        ...
        <form action="/admin/video/{{ $video->id }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title"
                    value="{{ old('title', $video->title) }}" placeholder="Masukkan judul video">
                @error('title')
            ...
            <div class="mb-3">
                ...
                <input type="text" id="youtube-link" class="form-control" placeholder="Masukkan link YouTube" value="{{ old('title', $video->url) }}" name="url">
                @error('url')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', () => {
                        ...
                        if (defaultUrl) {
                            const defaultPreview = createPreview(defaultUrl);
                            previewContainer.appendChild(defaultPreview);
                        }
                        ...
                        urlContainer.addEventListener('input', () => {
                            ...
                            if (link) {
                                const newPreview = createPreview(link);
